"""Dinocrit CLI entry point.

Dinocrit is a vibe coding companion - an LLM-powered code critic that helps
...
from dinocrit import __version__
from dinocrit.cli.console import console
from dinocrit.core.config import ConfigManager

# Create main app
app = typer.Typer(
    name="dino",
    help="Dinocrit: Your vibe coding companion - LLM-powered code critic",
...
def check(
    ...
    Dinocrit sends your code to an LLM for intelligent review. It doesn't do
    ...
    from dinocrit.core.logging import setup_logger
    ...
    if not quiet:
        console.info(f"Dinocrit v{__version__} - Analyzing...", err=True)
...
def packs_list(
    ...
    from dinocrit.packs.loader import get_all_packs
...
def packs_info(
    ...
    from dinocrit.packs.loader import get_pack
...
def cache_stats() -> None:
    ...
    from dinocrit.core.config import DEFAULT_CACHE_DB
...
def init(
    ...
    Creates a starter configuration for Dinocrit with sensible defaults.
    """
    ...
    default_config = """\
# Dinocrit - Your vibe coding companion
# https://github.com/diegogm/dinocrit
...
@app.command()
def version() -> None:
    """Show Dinocrit version information."""
    console.print(f"Dinocrit v{__version__}", style="bold cyan")
