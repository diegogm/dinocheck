...
from dinocrit.core.types import FileContext, Rule
...
class CriticPromptBuilder:
    ...
    SYSTEM_TEMPLATE = """You are Dinocrit, an expert code reviewer specializing in {pack_name}.
Your task is to identify code quality issues based on the provided rules and context.

Dinocrit is a vibe coding companion - it helps developers by providing a second opinion
